...
import com.github.tonysobreira.citiesapi.cities.service.DistanceService;
import com.github.tonysobreira.citiesapi.cities.service.EarthRadius;
...
public class DistanceResource {
	...
	@GetMapping("/by-math-points")
	public Double byMathPoints(@RequestParam(name = "from") final Long city1,
			@RequestParam(name = "to") final Long city2, @RequestParam final EarthRadius unit) {
		log.info("byMath");
		return service.distanceUsingPoints(city1, city2, unit);
	}
